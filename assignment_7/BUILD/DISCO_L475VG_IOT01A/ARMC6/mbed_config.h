...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "Dothenheimer"                                                                                   // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "Dyrehjemmet2.0"                                                                                 // set by application[*]
